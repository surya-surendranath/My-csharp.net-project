<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="AddStudentAdmin.aspx.cs" Inherits="AddStudentAdmin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <p>
        <span class="auto-style3">Mobile Number:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><asp:TextBox ID="txbMobile" runat="server" Width="158px" OnTextChanged="txbMobile_TextChanged" CssClass="auto-style3"></asp:TextBox>
    </p>
    <p>
    ...
    <p>
        ...
        <span class="auto-style3">&nbsp;</span></p>
    <p>
        <span class="auto-style3">Ethnicity:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        </span>
    ...
    <p>
        ...
        onselectedindexchanged="ddlFaculty_SelectedIndexChanged" DataSourceID="SqlDataSource1" DataTextField="Faculty" DataValueField="Faculty" Height="24px" Width="249px" CssClass="auto-style3">
            <asp:ListItem></asp:ListItem>
        </asp:DropDownList>
        <asp:SqlDataSource ID="SqlDataSource4" runat="server" ConnectionString="<%$ ConnectionStrings:FinanceDBConnectionString1 %>" SelectCommand="SELECT [Faculty], [Courses] FROM [Faculty] WHERE ([Faculty] = @Faculty)">
            <SelectParameters>
...
<p class="auto-style3">
    ...
    <p>
        ...
        <asp:DropDownList ID="DropDownList1" runat="server" AutoPostBack="True" DataSourceID="SqlDataSource5" DataTextField="Courses" DataValueField="Courses" Height="24px" style="margin-left: 0px" Width="238px" CssClass="auto-style3">
        </asp:DropDownList>
        <span class="auto-style3">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;</span></p>
    <p>
...
<p>
    ...
    <p>
        <span class="auto-style3">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span>
        <asp:Button ID="Button1" runat="server" CssClass="auto-style3" OnClick="Button1_Click" Text="Go Back &lt;-" Width="89px" />
    </p>
</asp:Content>
